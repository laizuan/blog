...
:::
- 属性配置
![属性配置1]($withBase('/img/generate_01.png'))
![属性配置2]($withBase('/img/generate_02.png'))

- 配置菜单  
假如我生成了`company_user`这个表的前端代码，那么新建一个菜单如下：
![菜单配置]($withBase('/img/generate_03.png'))
1. 路由名称使用中横线隔开
...
![rpc_01]($withBase('/img/rpc_01.png'))  
